...
#pragma warning disable SA1600 // Elements should be documented
    internal static class NativeMethods
    {
        ...
        // The vendored Microsoft.Terminal.Control.dll (Windows Terminal 1.24.11321.0, see
        // src/Microsoft-Terminal/native/NOTICE.md) predates the consolidated TerminalSetFocused(bool)
        // export used by current upstream WpfTerminalControl source; it only exports the older split
        // TerminalSetFocus/TerminalKillFocus pair. Call sites pick whichever matches the intended state.
        [DllImport("Microsoft.Terminal.Control.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall, PreserveSig = true)]
